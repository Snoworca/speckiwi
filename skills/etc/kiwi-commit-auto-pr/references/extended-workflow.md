...
If remote tracking is missing, do not move the protected branch pointer; warn
and continue on the feature branch.
...
The local evaluator checks body accuracy, issue/REQ consistency, risk honesty,
signature absence, and overclaiming. The body is accepted only after three
consecutive no-actionable-improvement evaluations.
