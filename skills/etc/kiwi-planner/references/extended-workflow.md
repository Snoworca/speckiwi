...
interface TddDecision {
  ...
  user_decision_id: string;       // User clarification gate 응답 식별자
...
| validator C15 (mcp_call_log mismatch) | 작성자 재호출 + replay | 3회 잔존 시 §0.G5 발동 |
...
| 동일 finding 3 라운드 연속 잔존 | 사용자 알림 (User clarification gate) | §0.G5 |
