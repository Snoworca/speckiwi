...
function positionFromYamlError(error: { linePos?: [{ line: number; col: number }, ...{ line: number; col: number }[]] }): {
  line?: number;
  column?: number;
} {
...
function positionFromNode(node: ParsedNode | { range?: Range | null }, lineCounter: LineCounter): { line?: number; column?: number } {
