...
/**
 * FR-NODE-053 — infer a scope document's prefix from the requirement id prefixes it holds.
...
/**
 * FR-NODE-053 — render the Scope Map row for a newly registered scope document. The Document
...
/**
 * FR-NODE-053 — locate the line after the last Scope Map table row so a new row is appended
...
/**
 * FR-NODE-053 — registerScopes core mutation. Adds every discovered srs.md scope document
