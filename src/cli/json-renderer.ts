import type { JsonObject, JsonValue } from "../core/dto.js";

export function renderJson(result: unknown): string {
  return `${stableStringify(toJsonObject(result, new WeakSet<object>()))}\n`;
}
...
function toJsonObject(value: unknown, seen: WeakSet<object>): JsonObject {
