...
function isFastValidSrsDocument(value) {
...
function isFastValidSrsRequirement(value) {
...
function isFastValidAcceptanceCriterion(value) {
...
function isFastValidRelation(value) {
...
function stringIn(value, allowed) {
    return typeof value === "string" && allowed.has(value);
}
function optionalStringIn(value, allowed) {
...
function optionalArray(value, guard) {
