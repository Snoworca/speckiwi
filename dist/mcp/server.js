...
export function createMcpServer(input) {
    ...
    server.registerResource("speckiwi_overview", "speckiwi://overview", {
        title: "SpecKiwi overview",
        description: "Raw .speckiwi/overview.yaml",
        mimeType: "application/yaml"
    }, (uri) => readMcpResource(uri.toString(), core));
    server.registerResource("speckiwi_index", "speckiwi://index", {
        title: "SpecKiwi index",
        description: "Raw .speckiwi/index.yaml",
        mimeType: "application/yaml"
    }, (uri) => readMcpResource(uri.toString(), core));
    server.registerResource("speckiwi_document", new ResourceTemplate("speckiwi://documents/{id}", { list: undefined }), {
        title: "SpecKiwi document",
        description: "Raw YAML for a registered document",
        mimeType: "application/yaml"
    }, (uri) => readMcpResource(uri.toString(), core));
    server.registerResource("speckiwi_requirement", new ResourceTemplate("speckiwi://requirements/{id}", { list: undefined }), {
        title: "SpecKiwi requirement context",
        description: "Stable JSON context for a requirement",
        mimeType: "application/json"
    }, (uri) => readMcpResource(uri.toString(), core));
    server.registerResource("speckiwi_scope", new ResourceTemplate("speckiwi://scopes/{id}", { list: undefined }), {
...
export async function runMcpServer(input) {
